...
function HeroSection() {
    return (
        <div className='h-[100vh] bg-dev-sohan-banner bg-cover bg-center'>
            <Particle />
            <div className='w-4/5 grid-cols-1 mx-auto grid lg:grid-cols-2 gap-12 h-full items-center'>
                <div className='flex flex-col gap-y-4'>
                    ...
                    <div className='mt-8 flex-col space-y-6 sm:space-y-0 sm:flex sm:flex-row items-center sm:space-x-6'>
                        <button className='px-8 py-4 bg-dev-sohan-blue hover:bg-yellow-400 transition-all duration-200 text-lg font-bold uppercase text-black flex items-center space-x-2 rounded-md'>
                            <p>Download CV</p>
                            <ArrowDownTrayIcon className='w-6 h-6 text-black'/>
                        </button>
                    </div>
                </div>
                {/* <div className='w-[500px] hidden bg-dev-sohan-green relative lg:flex items-center rounded-full h-[500px]'>
