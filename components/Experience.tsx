...
function Experience() {
    return (
        <div className='bg-dev-sohan-black-2 pb-5'>
            <div className='text-center pt-5 md:pt-10  mx-auto px-4 md:px-8 lg:max-w-screen-xl md:max-w-screen-lg'>
                <h2 className='text-lg md:text-3xl lg:text-5xl leading-8 md:leading-12 capitalize mb-12 font-bold text-white'>
                    <span className='text-yellow-400'>Educations</span>
                </h2>
            </div>
            <div className='mx-auto lg:max-w-screen-xl md:max-w-screen-lg px-5 py-5 mb-5 md:px-0 md:py-12 md:mb-10 before:content-[""] before:w-2 before:bg-yellow-300 before:h-full before:absolute before:left-1/2 before:top-0 before:-translate-x-1/2 before:z-0 relative md:flex md:flex-col lg:gap-y-6'>
                {
